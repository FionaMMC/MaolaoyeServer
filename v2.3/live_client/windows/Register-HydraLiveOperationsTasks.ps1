...
$items = @(
    ...
    @{ Name = "Hydra-Live-ExecutionData-1530"; Stage = "publish-execution"; Hour = 15; Minute = 30; LimitMinutes = 20; RestartCount = 1; RestartMinutes = 5 },
    @{ Name = "Hydra-Live-SettleClose-1510"; Stage = "settle-close"; Hour = 15; Minute = 10; LimitMinutes = 10; RestartCount = 1; RestartMinutes = 5 },
...
$legacyNames = @(
    ...
    "Hydra-Live-SettleClose-1605",
    "Hydra-Live-Trigger-1600",
    "Hydra-Live-Retry-1620",
